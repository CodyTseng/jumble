export default {
  translation: {
    ...
    Bio: 'Biografía',
    'Nostr Address': 'Dirección Nostr',
    'Nostr Address Info':
      'Una dirección Nostr es un nombre de usuario que parece un correo electrónico (ej., usuario@dominio.com) y se vincula a tu cuenta de Nostr para que otros puedan encontrarte y verificarte fácilmente.',
    ...
    'Button radius': 'Radio de botón',
    'Fully rounded': 'Completamente redondeado',
    ...
    'Follow some people to see their long-form articles here': 'Sigue a algunas personas para ver sus artículos de formato largo aquí',
    ...
    'Following...': 'Siguiendo...',
    'You are already following everyone in this list': 'Ya estás siguiendo a todos en esta lista',
    ...
    'Please select a GIF smaller than 10MB': 'Por favor selecciona un GIF menor de 10MB',
    ...
    'Your GIF has been uploaded successfully and is now available in "My Gifs"': 'Tu GIF se ha subido correctamente y ahora está disponible en "Mis GIFs"',
    'Failed to upload GIF': 'Error al subir el GIF',
    'Distraction-Free Mode': 'Modo Sin Distracciones',
    'Drain my time': 'Consumir mi tiempo',
    'Focus mode': 'Modo de enfoque',
    'Hide lists in navigation': 'Ocultar listas en la navegación',
    'Powered by nostr.band API. Issues may be due to API availability.':
      'Powered by nostr.band API. Los problemas pueden deberse a la disponibilidad de la API.'
  }
}
