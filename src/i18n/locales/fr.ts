export default {
  translation: {
    ...
    'Nostr Address Info':
      'Une adresse Nostr est un nom d\'utilisateur qui ressemble à un e-mail (ex., utilisateur@domaine.com) et se lie à votre compte Nostr pour que les autres puissent vous trouver et vous vérifier facilement.',
    ...
    'By': 'Par',
    'People': 'Personnes',
    'Follow All ({{count}})': 'Tout suivre ({{count}})',
    'Following...': 'Abonnement en cours...',
    'You are already following everyone in this list': 'Vous suivez déjà tout le monde dans cette liste',
    'Followed {{count}} {{word}}': 'Suivi {{count}} {{word}}',
    'user': 'utilisateur',
    'users': 'utilisateurs',
    ...
    'Found {{count}} GIFs': '{{count}} GIFs trouvés',
    'All Gifs': 'Tous les GIFs',
    'My Gifs': 'Mes GIFs',
    'My GIFs': 'Mes GIFs',
    'Upload GIF': 'Télécharger un GIF',
    'Please log in to view and upload your GIFs': 'Veuillez vous connecter pour voir et télécharger vos GIFs',
    "You haven't uploaded any GIFs yet": "Vous n'avez pas encore téléchargé de GIFs",
    'Upload a GIF to share with the Nostr community. It will be published as a kind 1063 event.': 'Téléchargez un GIF pour le partager avec la communauté Nostr. Il sera publié en tant qu\'événement de type 1063.',
    'Click to select a GIF file': 'Cliquez pour sélectionner un fichier GIF',
    'Max size: 10MB': 'Taille maximale : 10 Mo',
    'Please select a GIF file': 'Veuillez sélectionner un fichier GIF',
    'Please select a GIF smaller than 10MB': 'Veuillez sélectionner un GIF inférieur à 10 Mo',
    'Describe your GIF to help others find it (e.g., "happy cat dancing")': 'Décrivez votre GIF pour aider les autres à le trouver (par ex., "chat heureux qui danse")',
    ...
    'Your GIF has been uploaded successfully and is now available in "My Gifs"': 'Votre GIF a été téléchargé avec succès et est maintenant disponible dans "Mes GIFs"',
    'Failed to upload GIF': 'Échec du téléchargement du GIF',
    'Distraction-Free Mode': 'Mode Sans Distraction',
    'Drain my time': 'Drainer mon temps',
    ...
    'Powered by nostr.band API. Issues may be due to API availability.':
      'Propulsé par l\'API nostr.band. Les problèmes peuvent être dus à la disponibilité de l\'API.'
  }
}
