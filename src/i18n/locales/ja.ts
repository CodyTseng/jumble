export default {
  translation: {
    ...
    None: 'なし',
    Random: 'ランダム',
    'Zap Sound 1': 'Zapサウンド 1',
    'Electric Zap': 'エレクトリックZap',
    'Sending a message': 'メッセージを送信中',
    ...
    'Fully rounded': '完全に丸い',
    'Square corners': '角張った角',
    Square: '四角',
    Round: '丸',
    'Hide widget': 'ウィジェットを非表示',
    'Reads': '読み物',
    'Please login to view reads from people you follow': 'フォローしている人の読み物を表示するにはログインしてください',
    'Follow some people to see their long-form articles here': '長文記事を見るために何人かをフォローしてください',
    ...
    'By': '作成者',
    'People': '人々',
    'Follow All ({{count}})': '全員をフォロー ({{count}})',
    'Following...': 'フォロー中...',
    'You are already following everyone in this list': 'このリストの全員を既にフォローしています',
    'Followed {{count}} {{word}}': '{{count}}{{word}}をフォローしました',
    'user': 'ユーザー',
    'users': 'ユーザー',
    'Failed to follow all users': '全ユーザーのフォローに失敗しました',
    'Add GIF': 'GIFを追加',
    'Search GIFs...': 'GIFを検索...',
    'No GIFs found': 'GIFが見つかりません',
    'No recent GIFs': '最近のGIFはありません',
    'Found {{count}} GIFs': '{{count}}個のGIFが見つかりました',
    'All Gifs': 'すべてのGIF',
    'My Gifs': 'マイGIF',
    'My GIFs': 'マイGIF',
    'Upload GIF': 'GIFをアップロード',
    'Please log in to view and upload your GIFs': 'GIFを表示およびアップロードするにはログインしてください',
    "You haven't uploaded any GIFs yet": 'まだGIFをアップロードしていません',
    'Upload a GIF to share with the Nostr community. It will be published as a kind 1063 event.': 'Nostrコミュニティと共有するGIFをアップロードします。kind 1063イベントとして公開されます。',
    ...
    'Describe your GIF to help others find it (e.g., "happy cat dancing")': '他の人が見つけやすいようにGIFを説明してください（例：「楽しく踊る猫」）',
    ...
    'Please add a description to help others find your GIF': '他の人がGIFを見つけやすくするために説明を追加してください',
    ...
    'Drain my time': '時間を費やす',
    'Focus mode': 'フォーカスモード',
    'Hide lists in navigation': 'ナビゲーションのリストを非表示',
    'Powered by nostr.band API. Issues may be due to API availability.':
      'nostr.band APIによって提供されています。問題はAPIの可用性に起因する可能性があります。'
  }
}
