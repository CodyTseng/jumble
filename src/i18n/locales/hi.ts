export default {
  translation: {
    ...
    'Take a quick tour to learn about decentralized social networking, relays, and how Nostr works.': 'विकेन्द्रीकृत सामाजिक नेटवर्किंग, रिले और Nostr कैसे काम करता है के बारे में जानने के लिए एक त्वरित टूर लें।',
    'Start Tour': 'टूर शुरू करें',
    'Zap Sound': 'Zap ध्वनि',
    None: 'कोई नहीं',
    Random: 'यादृच्छिक',
    'Zap Sound 1': 'Zap ध्वनि 1',
    'Electric Zap': 'इलेक्ट्रिक Zap',
    'Sending a message': 'संदेश भेजना',
    'No second best': 'दूसरा सबसे अच्छा नहीं',
    Freedom: 'स्वतंत्रता',
    'Hey Hey Hey': 'हे हे हे',
    'Font family': 'फ़ॉन्ट परिवार',
    'Font size': 'फ़ॉन्ट आकार',
    'Button radius': 'बटन त्रिज्या',
    'Fully rounded': 'पूरी तरह से गोल',
    'Square corners': 'वर्ग कोने',
    Square: 'वर्ग',
    Round: 'गोल',
    'Hide widget': 'विजेट छिपाएं',
    'Reads': 'पठन',
    'Please login to view reads from people you follow': 'कृपया उन लोगों से पठन देखने के लिए लॉगिन करें जिन्हें आप फ़ॉलो करते हैं',
    'Follow some people to see their long-form articles here': 'यहां उनके लंबे-फॉर्म लेख देखने के लिए कुछ लोगों को फ़ॉलो करें',
    ...
    'You are already following everyone in this list': 'आप पहले से ही इस सूची में सभी को फ़ॉलो कर रहे हैं',
    'Followed {{count}} {{word}}': '{{count}} {{word}} फ़ॉलो किया',
    'user': 'उपयोगकर्ता',
    'users': 'उपयोगकर्ता',
    'Failed to follow all users': 'सभी उपयोगकर्ताओं को फ़ॉलो करने में विफल',
    'Add GIF': 'GIF जोड़ें',
    'Search GIFs...': 'GIF खोजें...',
    'No GIFs found': 'कोई GIF नहीं मिला',
    'No recent GIFs': 'कोई हालिया GIF नहीं',
    'Found {{count}} GIFs': '{{count}} GIF मिले',
    'All Gifs': 'सभी GIF',
    'My Gifs': 'मेरे GIF',
    'My GIFs': 'मेरे GIF',
    'Upload GIF': 'GIF अपलोड करें',
    'Please log in to view and upload your GIFs': 'कृपया अपने GIF देखने और अपलोड करने के लिए लॉगिन करें',
    "You haven't uploaded any GIFs yet": 'आपने अभी तक कोई GIF अपलोड नहीं किया है',
    'Upload a GIF to share with the Nostr community. It will be published as a kind 1063 event.': 'Nostr समुदाय के साथ साझा करने के लिए एक GIF अपलोड करें। यह kind 1063 इवेंट के रूप में प्रकाशित किया जाएगा।',
    'Click to select a GIF file': 'GIF फ़ाइल चुनने के लिए क्लिक करें',
    'Max size: 10MB': 'अधिकतम आकार: 10MB',
    'Please select a GIF file': 'कृपया एक GIF फ़ाइल चुनें',
    'Please select a GIF smaller than 10MB': 'कृपया 10MB से छोटा GIF चुनें',
    'Describe your GIF to help others find it (e.g., "happy cat dancing")': 'दूसरों को इसे खोजने में मदद करने के लिए अपने GIF का वर्णन करें (जैसे, "खुश बिल्ली नृत्य कर रही है")',
    ...
    'Please add a description to help others find your GIF': 'कृपया दूसरों को अपना GIF खोजने में मदद करने के लिए एक विवरण जोड़ें',
    'Your GIF has been uploaded successfully and is now available in "My Gifs"': 'आपका GIF सफलतापूर्वक अपलोड किया गया है और अब "मेरे GIF" में उपलब्ध है',
    'Failed to upload GIF': 'GIF अपलोड करने में विफल',
    'Distraction-Free Mode': 'विकर्षण-मुक्त मोड',
    ...
    'Powered by nostr.band API. Issues may be due to API availability.':
      'nostr.band API द्वारा संचालित। समस्याएं API उपलब्धता के कारण हो सकती हैं।'
  }
}
