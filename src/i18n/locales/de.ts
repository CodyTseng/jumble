export default {
  translation: {
    ...
    'Nostr Address Info':
      'Eine Nostr-Adresse ist ein Benutzername, der wie eine E-Mail aussieht (z.B. benutzer@domain.com) und mit Ihrem Nostr-Konto verknüpft ist, damit andere Sie leicht finden und verifizieren können.',
    ...
    'No second best': 'Keine zweite Wahl',
    Freedom: 'Freiheit',
    ...
    'Reads': 'Lektüre',
    'Please login to view reads from people you follow': 'Bitte melden Sie sich an, um Lektüre von Personen zu sehen, denen Sie folgen',
    'Follow some people to see their long-form articles here': 'Folgen Sie einigen Personen, um deren Langartikel hier zu sehen',
    ...
    'By': 'Von',
    'People': 'Personen',
    'Follow All ({{count}})': 'Alle folgen ({{count}})',
    'Following...': 'Folge...',
    ...
    'user': 'Benutzer',
    'users': 'Benutzer',
    'Failed to follow all users': 'Fehler beim Folgen aller Benutzer',
    ...
    'Please log in to view and upload your GIFs': 'Bitte melden Sie sich an, um Ihre GIFs anzuzeigen und hochzuladen',
    "You haven't uploaded any GIFs yet": 'Sie haben noch keine GIFs hochgeladen',
    'Upload a GIF to share with the Nostr community. It will be published as a kind 1063 event.': 'Laden Sie ein GIF hoch, um es mit der Nostr-Community zu teilen. Es wird als Event der Art 1063 veröffentlicht.',
    'Click to select a GIF file': 'Klicken Sie, um eine GIF-Datei auszuwählen',
    'Max size: 10MB': 'Maximale Größe: 10 MB',
    'Please select a GIF file': 'Bitte wählen Sie eine GIF-Datei aus',
    'Please select a GIF smaller than 10MB': 'Bitte wählen Sie ein GIF unter 10 MB aus',
    'Describe your GIF to help others find it (e.g., "happy cat dancing")': 'Beschreiben Sie Ihr GIF, damit andere es finden können (z.B. "glückliche tanzende Katze")',
    ...
    'Please log in and select a file': 'Bitte melden Sie sich an und wählen Sie eine Datei aus',
    'Please add a description to help others find your GIF': 'Bitte fügen Sie eine Beschreibung hinzu, damit andere Ihr GIF finden können',
    'Your GIF has been uploaded successfully and is now available in "My Gifs"': 'Ihr GIF wurde erfolgreich hochgeladen und ist jetzt in "Meine GIFs" verfügbar',
    'Failed to upload GIF': 'Fehler beim Hochladen des GIF',
    'Distraction-Free Mode': 'Ablenkungsfreier Modus',
    'Drain my time': 'Meine Zeit verschwenden',
    'Focus mode': 'Fokusmodus',
    'Hide lists in navigation': 'Listen in der Navigation ausblenden',
    'Powered by nostr.band API. Issues may be due to API availability.':
      'Bereitgestellt von nostr.band API. Probleme können auf die API-Verfügbarkeit zurückzuführen sein.'
  }
}
