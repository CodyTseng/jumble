export default {
  translation: {
    ...
    'Button radius': 'Raggio pulsante',
    'Fully rounded': 'Completamente arrotondato',
    'Square corners': 'Angoli quadrati',
    Square: 'Quadrato',
    Round: 'Rotondo',
    'Hide widget': 'Nascondi widget',
    'Reads': 'Letture',
    'Please login to view reads from people you follow': 'Effettua il login per vedere le letture delle persone che segui',
    ...
    'Followed {{count}} {{word}}': 'Seguito {{count}} {{word}}',
    'user': 'utente',
    'users': 'utenti',
    ...
    'Please log in to view and upload your GIFs': 'Effettua il login per vedere e caricare le tue GIF',
    ...
    'Click to select a GIF file': 'Fai clic per selezionare un file GIF',
    'Max size: 10MB': 'Dimensione massima: 10 MB',
    'Please select a GIF file': 'Seleziona un file GIF',
    'Please select a GIF smaller than 10MB': 'Seleziona una GIF inferiore a 10 MB',
    'Describe your GIF to help others find it (e.g., "happy cat dancing")': 'Descrivi la tua GIF per aiutare gli altri a trovarla (ad es., "gatto felice che balla")',
    ...
    'Failed to upload GIF': 'Impossibile caricare la GIF',
    'Distraction-Free Mode': 'Modalità senza distrazioni',
    'Drain my time': 'Consuma il mio tempo',
    ...
    'Powered by nostr.band API. Issues may be due to API availability.':
      'Alimentato da API nostr.band. I problemi potrebbero essere dovuti alla disponibilità dell\'API.'
  }
}
