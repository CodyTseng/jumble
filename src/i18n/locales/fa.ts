export default {
  translation: {
    ...
    'New to Nostr?': 'تازه وارد Nostr هستید؟',
    'Take a quick tour to learn about decentralized social networking, relays, and how Nostr works.': 'یک تور سریع بگذرانید تا در مورد شبکه‌های اجتماعی غیرمتمرکز، رله‌ها و نحوه کار Nostr بیاموزید.',
    'Start Tour': 'شروع تور',
    'Zap Sound': 'صدای Zap',
    None: 'هیچ',
    Random: 'تصادفی',
    'Zap Sound 1': 'صدای Zap 1',
    'Electric Zap': 'Zap الکتریکی',
    'Sending a message': 'ارسال پیام',
    'No second best': 'دوم بهترین نیست',
    Freedom: 'آزادی',
    ...
    'Reads': 'خواندنی‌ها',
    'Please login to view reads from people you follow': 'لطفاً وارد شوید تا خواندنی‌های افرادی که دنبال می‌کنید را ببینید',
    'Follow some people to see their long-form articles here': 'برخی افراد را دنبال کنید تا مقالات بلند آنها را اینجا ببینید',
    ...
    'You are already following everyone in this list': 'شما در حال حاضر همه در این لیست را دنبال می‌کنید',
    ...
    'No GIFs found': 'هیچ GIF یافت نشد',
    'No recent GIFs': 'هیچ GIF اخیر',
    'Found {{count}} GIFs': '{{count}} GIF یافت شد',
    'All Gifs': 'همه GIF‌ها',
    'My Gifs': 'GIF‌های من',
    'My GIFs': 'GIF‌های من',
    'Upload GIF': 'بارگذاری GIF',
    'Please log in to view and upload your GIFs': 'لطفاً وارد شوید تا GIF‌های خود را مشاهده و بارگذاری کنید',
    "You haven't uploaded any GIFs yet": 'شما هنوز هیچ GIF بارگذاری نکرده‌اید',
    'Upload a GIF to share with the Nostr community. It will be published as a kind 1063 event.': 'یک GIF بارگذاری کنید تا با جامعه Nostr به اشتراک بگذارید. به عنوان رویداد نوع 1063 منتشر خواهد شد.',
    'Click to select a GIF file': 'برای انتخاب فایل GIF کلیک کنید',
    'Max size: 10MB': 'حداکثر اندازه: 10 مگابایت',
    'Please select a GIF file': 'لطفاً یک فایل GIF انتخاب کنید',
    'Please select a GIF smaller than 10MB': 'لطفاً یک GIF کمتر از 10 مگابایت انتخاب کنید',
    ...
    'This description will be used for searching and accessibility': 'این توضیحات برای جستجو و دسترسی استفاده خواهد شد',
    'Please log in and select a file': 'لطفاً وارد شوید و یک فایل انتخاب کنید',
    'Please add a description to help others find your GIF': 'لطفاً توضیحی اضافه کنید تا دیگران GIF شما را پیدا کنند',
    'Your GIF has been uploaded successfully and is now available in "My Gifs"': 'GIF شما با موفقیت بارگذاری شد و اکنون در "GIF‌های من" در دسترس است',
    'Failed to upload GIF': 'بارگذاری GIF ناموفق بود',
    'Distraction-Free Mode': 'حالت بدون حواس‌پرتی',
    'Drain my time': 'تلف کردن وقتم',
    'Focus mode': 'حالت تمرکز',
    'Hide lists in navigation': 'پنهان کردن لیست‌ها در ناوبری',
    'Powered by nostr.band API. Issues may be due to API availability.':
      'با استفاده از API nostr.band. مشکلات ممکن است به دلیل در دسترس بودن API باشد.'
  }
}
