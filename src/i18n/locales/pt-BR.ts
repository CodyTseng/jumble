export default {
  translation: {
    ...
    'Nostr Address Info':
      'Um endereço Nostr é um nome de usuário que se parece com um e-mail (ex: usuario@dominio.com) e está vinculado à sua conta Nostr para que outras pessoas possam encontrá-lo e verificá-lo facilmente.',
    ...
    'Following...': 'Seguindo...',
    'You are already following everyone in this list': 'Você já está seguindo todos nesta lista',
    ...
    'My Gifs': 'Meus GIFs',
    'My GIFs': 'Meus GIFs',
    'Upload GIF': 'Enviar GIF',
    'Please log in to view and upload your GIFs': 'Faça login para ver e enviar seus GIFs',
    "You haven't uploaded any GIFs yet": 'Você ainda não enviou nenhum GIF',
    'Upload a GIF to share with the Nostr community. It will be published as a kind 1063 event.': 'Envie um GIF para compartilhar com a comunidade Nostr. Será publicado como um evento do tipo 1063.',
    ...
    'Please select a GIF smaller than 10MB': 'Selecione um GIF menor que 10MB',
    ...
    'Please log in and select a file': 'Faça login e selecione um arquivo',
    'Please add a description to help others find your GIF': 'Adicione uma descrição para ajudar outros a encontrar seu GIF',
    ...
    'Failed to upload GIF': 'Falha ao enviar GIF',
    'Distraction-Free Mode': 'Modo Sem Distrações',
    'Drain my time': 'Drenar meu tempo',
    ...
    'Powered by nostr.band API. Issues may be due to API availability.':
      'Alimentado pela API nostr.band. Problemas podem ser devidos à disponibilidade da API.'
  }
}
