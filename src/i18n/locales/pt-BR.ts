export default {
  translation: {
    ...
    'Your DM Relays': 'Seus relays de MD',
    ...
    'Failed to save DM relays': 'Falha ao salvar relays de MD',
    ...
    'An encryption key was found for your account. Please open a client that already has your DM encryption key set up to approve the sync request.':
      'Uma chave de criptografia foi encontrada para sua conta. Abra um cliente que já tenha sua chave de criptografia de MD configurada para aprovar a solicitação de sincronização.',
    ...
    'Sign in to use Messages': 'Entre para usar Mensagens',
    ...
    'This user has not set up NIP-4e DMs': 'Este usuário não configurou DMs NIP-4e',
