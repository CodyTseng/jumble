export default {
  translation: {
    ...
    None: 'لا شيء',
    Random: 'عشوائي',
    'Zap Sound 1': 'صوت Zap 1',
    'Electric Zap': 'Zap كهربائي',
    ...
    'Font size': 'حجم الخط',
    'Button radius': 'نصف قطر الزر',
    'Fully rounded': 'مستدير تمامًا',
    'Square corners': 'زوايا مربعة',
    Square: 'مربع',
    Round: 'مستدير',
    'Hide widget': 'إخفاء الأداة',
    'Reads': 'القراءات',
    'Please login to view reads from people you follow': 'يرجى تسجيل الدخول لمشاهدة قراءات الأشخاص الذين تتابعهم',
    ...
    'Following...': 'متابعة...',
    'You are already following everyone in this list': 'أنت تتابع بالفعل الجميع في هذه القائمة',
    'Followed {{count}} {{word}}': 'تمت متابعة {{count}} {{word}}',
    'user': 'مستخدم',
    'users': 'مستخدمين',
    'Failed to follow all users': 'فشل متابعة جميع المستخدمين',
    'Add GIF': 'إضافة GIF',
    'Search GIFs...': 'البحث عن GIF...',
    'No GIFs found': 'لم يتم العثور على GIF',
    'No recent GIFs': 'لا توجد GIF حديثة',
    'Found {{count}} GIFs': 'تم العثور على {{count}} GIF',
    'All Gifs': 'جميع GIF',
    'My Gifs': 'GIF الخاصة بي',
    'My GIFs': 'GIF الخاصة بي',
    'Upload GIF': 'تحميل GIF',
    'Please log in to view and upload your GIFs': 'يرجى تسجيل الدخول لعرض وتحميل GIF الخاصة بك',
    "You haven't uploaded any GIFs yet": 'لم تقم بتحميل أي GIF بعد',
    'Upload a GIF to share with the Nostr community. It will be published as a kind 1063 event.': 'قم بتحميل GIF للمشاركة مع مجتمع Nostr. سيتم نشره كحدث من النوع 1063.',
    'Click to select a GIF file': 'انقر لتحديد ملف GIF',
    'Max size: 10MB': 'الحجم الأقصى: 10 ميجابايت',
    'Please select a GIF file': 'يرجى تحديد ملف GIF',
    'Please select a GIF smaller than 10MB': 'يرجى تحديد GIF أصغر من 10 ميجابايت',
    'Describe your GIF to help others find it (e.g., "happy cat dancing")': 'صف GIF الخاص بك لمساعدة الآخرين في العثور عليه (مثل "قطة سعيدة ترقص")',
    ...
    'Please add a description to help others find your GIF': 'يرجى إضافة وصف لمساعدة الآخرين في العثور على GIF الخاص بك',
    'Your GIF has been uploaded successfully and is now available in "My Gifs"': 'تم تحميل GIF الخاص بك بنجاح وهو متاح الآن في "GIF الخاصة بي"',
    'Failed to upload GIF': 'فشل تحميل GIF',
    'Distraction-Free Mode': 'وضع خالٍ من التشتيت',
    'Drain my time': 'استنزاف وقتي',
    ...
    'Powered by nostr.band API. Issues may be due to API availability.':
      'مدعوم بواسطة API nostr.band. قد تكون المشكلات بسبب توفر API.'
  }
}
