export default {
  translation: {
    ...
    'Electric Zap': '전기 Zap',
    'Sending a message': '메시지 보내기',
    'No second best': '차선책 없음',
    Freedom: '자유',
    'Hey Hey Hey': 'Hey Hey Hey',
    'Font family': '글꼴 패밀리',
    'Font size': '글꼴 크기',
    'Button radius': '버튼 둥근 정도',
    'Fully rounded': '완전히 둥글게',
    'Square corners': '각진 모서리',
    Square: '사각형',
    Round: '둥글게',
    'Hide widget': '위젯 숨기기',
    'Reads': '읽기',
    'Please login to view reads from people you follow': '팔로우하는 사람들의 읽기를 보려면 로그인하세요',
    'Follow some people to see their long-form articles here': '장문 글을 보려면 일부 사람들을 팔로우하세요',
    ...
    'Following...': '팔로우 중...',
    'You are already following everyone in this list': '이미 이 목록의 모든 사람을 팔로우하고 있습니다',
    'Followed {{count}} {{word}}': '{{count}}{{word}}를 팔로우했습니다',
    'user': '사용자',
    'users': '사용자',
    'Failed to follow all users': '모든 사용자 팔로우 실패',
    'Add GIF': 'GIF 추가',
    'Search GIFs...': 'GIF 검색...',
    ...
    'Click to select a GIF file': '클릭하여 GIF 파일 선택',
    'Max size: 10MB': '최대 크기: 10MB',
    'Please select a GIF file': 'GIF 파일을 선택하세요',
    'Please select a GIF smaller than 10MB': '10MB 미만의 GIF를 선택하세요',
    'Describe your GIF to help others find it (e.g., "happy cat dancing")': '다른 사람들이 찾을 수 있도록 GIF를 설명하세요 (예: "행복한 고양이 춤")',
    ...
    'Your GIF has been uploaded successfully and is now available in "My Gifs"': 'GIF가 성공적으로 업로드되었으며 이제 "내 GIF"에서 사용할 수 있습니다',
    'Failed to upload GIF': 'GIF 업로드 실패',
    'Distraction-Free Mode': '방해 금지 모드',
    'Drain my time': '시간 소비',
    'Focus mode': '집중 모드',
    'Hide lists in navigation': '탐색에서 목록 숨기기',
    'Powered by nostr.band API. Issues may be due to API availability.':
      'nostr.band API로 구동됩니다. 문제는 API 가용성 때문일 수 있습니다.'
  }
}
